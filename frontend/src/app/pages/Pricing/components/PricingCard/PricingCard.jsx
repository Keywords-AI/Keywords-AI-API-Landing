import { FeatureTick } from '../../../../components/icons';
...
export default function PricingCard({
  ...
  return (
    <div className="gradient-out p-[1px] rounded-xl  flex-1">
      <div className="gradient-in h-[718px] min-w-[278px] p-[24px] flex-col items-center gap-xl  rounded-xl">
